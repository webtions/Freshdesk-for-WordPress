...
2.  Unzip
3.  Upload `plugin-template` directory to your `/wp-content/plugins` directory
...
Take a look at the [official "Freshdesk for WordPress" FAQ](http://www.dreamsonline.net/wordpress-plugins/freshdesk-for-wordpress/
).
